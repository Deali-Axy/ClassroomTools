Attribute VB_Name = "Mod_HookSkinner"
'[Mod Name]Code Institute Common QApp Framework HookSkin Module
'[Mod Author]Code Institute
Option Explicit
#Const MLC_HookSkin = True    '模块加载配置，True即为加载该模块，False就是不加载
